    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                ...
                sources=[
                    'src/poly_nms_cuda.cpp', 'src/poly_nms_kernel.cu'
                ]),
            make_cuda_ext(
                name='roi_align_cuda',
            ...
            make_cuda_ext(
                ...
                module='mmdet.ops.psroi_align_rotated',
                sources=['src/psroi_align_rotated_cuda.cpp', 'src/psroi_align_rotated_kernel.cu']),
            make_cuda_ext(
