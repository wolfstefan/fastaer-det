...
pluginStatus_t allClassNMSRotated(cudaStream_t stream, int num, int num_classes, int num_preds_per_class, int top_k,
                           float nms_threshold, bool share_location, bool isNormalized, DataType DT_SCORE, DataType DT_BBOX, void* bbox_data,
                           void* beforeNMS_scores, void* beforeNMS_index_array, void* afterNMS_scores, void* afterNMS_index_array,
                           bool flipXY = false);
...
pluginStatus_t detectionInferenceRotated(cudaStream_t stream, int N, int C1, int C2, bool shareLocation,
                                         int backgroundLabelId, int numPredsPerClass, int numClasses, int topK, int keepTopK,
                                         float confidenceThreshold, float nmsThreshold, DataType DT_BBOX, const void* locData,
...
pluginStatus_t gatherTopDetectionsRotated(cudaStream_t stream, bool shareLocation, int numImages, int numPredsPerClass,
                                   int numClasses, int topK, int keepTopK, DataType DT_BBOX, DataType DT_SCORE, const void* indices,
                                   const void* scores, const void* bboxData, void* keepCount, void* topDetections);

size_t detectionForwardBBoxDataSize(int N, int C1, DataType DT_BBOX);

size_t detectionRotatedForwardBBoxDataSize(int N, int numPriors, DataType DT_BBOX);
