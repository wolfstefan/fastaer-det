...
from .anchor_head import AnchorHead, TopK, Gather
        ...
        for img_id in range(len(img_metas)):
            if is_in_onnx_export():
                ...
                centerness_pred_list = [
                    torch.squeeze(centernesses[i], dim=0).detach() for i in range(num_levels)
                ]
            else:
                cls_score_list = [
    ...
    def get_bboxes_single(self,
        ...
        for cls_score, bbox_pred, centerness, anchors in zip(
            ...
            if nms_pre > 0 and scores.shape[0] > nms_pre:
                ...
                centerness = Gather.apply(centerness, topk_inds)
